...
public class ArregloAtenciones {
	...
	private void cargarAtenciones() {
		try {
			...
			String[] s;
			int codigoAtencion, codigoCliente, estado;
			double totalPagar;
			...
			while ((linea=br.readLine()) != null) {
				...
				adicionar(new Atencion(codigoAtencion, codigoCliente,
	...
	public boolean procedeCodigoClientes(int codigoCliente) {
		for (int i=tamaño()-1; i>=0; i--)
			if (obtener(i).getCodigoCliente() == codigoCliente  &&  obtener(i).getEstado() == 0)
				return false;
		return true;
	}
